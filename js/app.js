...
let slider_about = new Swiper('.services-box__slider', {
...
/* 	pagination: {
	...
	// Arrows
	/* navigation: {
		nextEl: '.services-box__slider .more__item_next',
		prevEl: '.services-box__slider .more__item_prev',
	}, */
	/*
	breakpoints: {
		320: {
...
let slider_about2 = new Swiper('.reviews-slider', {
		...
		// Arrows
	 	 navigation: {
			nextEl: '.reviews-slider .services__btn-right',
			prevEl: '.reviews-slider .services__btn-left',
		},  
